...
const responsiveSpanClassMap: Record<string, string> = {
  'sm-1': 'sm:col-span-1',
  'sm-2': 'sm:col-span-2',
  'sm-3': 'sm:col-span-3',
  'sm-4': 'sm:col-span-4',
...
function getResponsiveSpanClass(
  ...
  return responsiveSpanClassMap[`${breakpoint}-${normalizedSize}`] ?? ''
}

const itemClasses = computed(() => [
  'col-span-full min-w-0',
  props.sm === undefined ? '' : getResponsiveSpanClass('sm', props.sm),
  props.md === undefined ? '' : getResponsiveSpanClass('md', props.md),
  props.lg === undefined ? '' : getResponsiveSpanClass('lg', props.lg),
  props.xl === undefined ? '' : getResponsiveSpanClass('xl', props.xl),
])
</script>
